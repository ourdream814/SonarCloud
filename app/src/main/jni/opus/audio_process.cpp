...
JNIEXPORT jint JNICALL Java_com_softrangers_sonarcloudmobile_utils_AudioProcessor_createEncoder(
        JNIEnv *env,
        jobject thiz,
        jint sampleRate,
        jint channels,
...
JNIEXPORT jint JNICALL Java_com_softrangers_sonarcloudmobile_utils_AudioProcessor_createDecoder(
        JNIEnv *env,
        jobject thiz,
        jint sampleRate,
        jint channels )
...
JNIEXPORT jint JNICALL Java_com_softrangers_sonarcloudmobile_utils_AudioProcessor_setBitrate( JNIEnv *env, jobject thiz, jint bitrate )
{
...
JNIEXPORT jint JNICALL Java_com_softrangers_sonarcloudmobile_utils_AudioProcessor_setSignal( JNIEnv *env, jobject thiz, jint signal )
{
    OpusEncoder *encoder = (OpusEncoder *)env->GetLongField( thiz, getOpusEncoder( env, thiz ) );
...
JNIEXPORT jint JNICALL Java_com_softrangers_sonarcloudmobile_utils_AudioProcessor_setComplexity( JNIEnv *env, jobject thiz, jint complexity )
{
    OpusEncoder *encoder = (OpusEncoder *)env->GetLongField( thiz, getOpusEncoder( env, thiz ) );
...
JNIEXPORT jint JNICALL Java_com_softrangers_sonarcloudmobile_utils_AudioProcessor_encode( JNIEnv *env,
                                                                                    jobject thiz,
                                                                                    jbyteArray pcm,
                                                                                    jint pcmOffset,
                                                                                    jint frameSize,
...
JNIEXPORT jint JNICALL Java_com_softrangers_sonarcloudmobile_utils_AudioProcessor_decode( JNIEnv *env,
                                                                                    jobject thiz,
                                                                                    jbyteArray data,
                                                                                    jint dataOffset,
                                                                                    jint dataSize,
...
JNIEXPORT void JNICALL Java_com_softrangers_sonarcloudmobile_utils_AudioProcessor_dealloc( JNIEnv *env, jobject thiz )
{
    jfieldID  encoderFieldID = getOpusEncoder( env, thiz );
    jfieldID  decoderFieldID = getOpusDecoder( env, thiz );
...
JNIEXPORT jstring JNICALL Java_com_softrangers_sonarcloudmobile_utils_AudioProcessor_opusStrError( JNIEnv *env,
                                                                                    jclass thiz,
                                                                                    jint error )
{
